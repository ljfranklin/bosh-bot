      ...
      convo.assetsFetcher.fetchAll(assetsToFetch, function(assetsErr) {
        ...
        convo.runner.showDiff(deployOpts, function(err, diffOutput) {
          ...
          bot.startConversation(message,function(err,conversation) {
            ...
            conversation.ask(prompt, [{ pattern: 'takeoff', callback: function(response,conversation) {
              var taskID = null;
              var taskStarted = function(id, cancelCb) {
                ...
                conversation.ask(cancelPrompt, [{ pattern: 'mayday', callback: function(response, conversation) {
            ...
            }}, { default: true, callback: function(response, conversation) {
